...
var EventEmitter = require('events').EventEmitter
  ...
  , DEFAULT_SUPPORTED_TYPES = [
    'application/json; charset=utf-8', 'application/javascript; charset=utf-8', 'application/xml; charset=utf-8',
    'text/javascript; charset=utf-8', 'text/xml; charset=utf-8',
    'json; charset=utf-8', 'xml; charset=utf-8',
    '*/*; charset=utf-8',
...
HttpContext.prototype.done = function () {
  ...
  var acceptableMIMEType = accepts;
  if (acceptableMIMEType) {
    acceptableMIMEType = acceptableMIMEType.replace(/;\s*charset=[^;]+;*/i, '');
  }

  var dataExists = typeof data !== 'undefined';
  if(dataExists) {
    switch(acceptableMIMEType) {
      case '*/*':
